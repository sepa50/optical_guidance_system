...
parser.add_argument(
    "--test_dir",
    default="/home/dmmm/University-Release/test",
    type=str,
    help="./test_data",
)
parser.add_argument(
...
parser.add_argument(
    "--mode", default="1", type=int, help="1:drone->satellite   2:satellite->drone"
)
parser.add_argument(
    "--num_worker", default=4, type=int, help="1:drone->satellite   2:satellite->drone"
)
